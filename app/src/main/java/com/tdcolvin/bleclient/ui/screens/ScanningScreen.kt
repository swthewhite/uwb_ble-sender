...
import com.tdcolvin.bleclient.ble.DeviceInfo
        ...
        LazyColumn(
            ...
            items(foundDevices) { device ->
                DeviceItem(
                    ...
                    deviceDistance = device.distance,
...
@Composable
fun DeviceItem(deviceName: String?, selectDevice: () -> Unit, deviceDistance: Double) {
    Card(
        modifier = Modifier
            .fillMaxWidth(),
        ...
        Column(modifier = Modifier.padding(10.dp)) {
            Text(
                text = deviceName + deviceDistance.toString(),
